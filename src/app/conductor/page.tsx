      ...
      <div className="mx-auto max-w-3xl px-6 pt-6 pb-16">
        <div className="space-y-6 text-sm leading-8 text-muted sm:text-base">
          ...
          <p>
            ...
            세계합창대회(World Choir Games) 어린이합창 부문에 출전해 실버
            디플로마(Silver Diploma)를 수상했고, 세종시 예술인상과 세종시
            교육감상(제119회 소방동요대회 대상 지도자상), 강경포구 전국
            어린이 동요대회 지도자상 등을 수상하며 지도력을 인정받았습니다.
          </p>
          <p>
            이에 앞서 계룡시 어린이 뮤지컬 합창단의 상임지휘자를 역임했고,
            경찰대학교 강사와 세종하모니앙상블 대표를 지내며 지휘 경험을
            쌓아왔습니다. 현재는 싱투게더콰이어 지휘자로도 활동하며,
