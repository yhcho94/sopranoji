    ...
    <div>
      ...
      <div className="mx-auto max-w-3xl px-6 pt-6 pb-16">
        <div className="space-y-6 text-sm leading-8 text-muted sm:text-base">
          ...
          <p>
            숙명여자대학교 성악과 석사를 마치고 이탈리아 페스카라 시립음악원
            최고연주자과정을 수료했습니다. 팝페라 그룹 &lsquo;칼라스&rsquo;와
            준 시어터 소속으로 활동했고, 스위스 취리히와 이탈리아 줄리아넬로
            초청 연주 등 국내외 무대에 섰습니다.
          </p>
          <p>
            현재는 세종드림예술기획 대표이자 세종리틀싱어즈 단장·상임지휘자로,
            성악가와 지휘자를 오가며 활동하고 있습니다. 자세한 경력과 수상
